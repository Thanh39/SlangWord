...
public class MenuFrame extends JFrame implements ActionListener {
	...
	MenuFrame() {
		...
		b1.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b1.setFocusable(false);

		b2 = new JButton("2. Find Slang word");
		b2.addActionListener(this);
		b2.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b2.setFocusable(false);

		b3 = new JButton("3. Add slang word");
		b3.addActionListener(this);
		b3.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b3.setFocusable(false);

		b4 = new JButton("4. Random Slang Words");
		b4.addActionListener(this);
		b4.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b4.setFocusable(false);

		b5 = new JButton("5. History");
		b5.addActionListener(this);
		b5.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b5.setFocusable(false);

		b6 = new JButton("6. Delete Slang Word");
		b6.addActionListener(this);
		b6.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b6.setFocusable(false);

		b7 = new JButton("7. Reset Slang Word");
		b7.addActionListener(this);
		b7.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b7.setFocusable(false);

		b8 = new JButton("8. Quiz");
		b8.addActionListener(this);
		b8.setFont(new Font("Gill Sans MT", Font.PLAIN, 16));
		b8.setFocusable(false);

		JPanel panelCenter = new JPanel();
		// panelCenter.setBackground(Color.gray);
		panelCenter.setLayout(new GridLayout(4, 4, 8, 8));
		panelCenter.add(b1);
		panelCenter.add(b2);
		panelCenter.add(b3);
		panelCenter.add(b4);
